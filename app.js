...
class MBSTSApp {
    ...
    async loadExtraQuestions() {
        try {
            const urls = ['questions-ek.json', 'questions-2024.json', 'questions-2023.json', 'questions-2022.json', 'questions-2021.json', 'questions-2020.json', 'questions-2019.json', 'questions-2018.json'];
